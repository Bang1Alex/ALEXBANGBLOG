...
let BAR_COLOR = "#8B4513"; // SaddleBrown
let STRICK_COLOR = "#D2B48C"; // Tan
let ENDING_BALL_COLOR = "#8B4513";
let RING_COLOR = ["#FFD700", "#C0C0C0", "#CD7F32", "#FFD700", "#C0C0C0", "#CD7F32", "#FFD700", "#C0C0C0", "#CD7F32"]; // Gold, Silver, Bronze
let HANDLE_BAR_COLOR1 = "#8B4513";
let HANDLE_BAR_COLOR2 = "#A0522D"; // Sienna
let SIGN_COLOR = "red";
let BAR_BOARD_FILL_COLOR = "#DEB887"; // BurlyWood
let BAR_BOARD_STROKE_COLOR = "#8B4513";
